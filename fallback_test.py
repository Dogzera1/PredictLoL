"""
Script simplificado para testar o serviço de previsão sem usar o modelo treinado.

Este script usa o algoritmo de fallback do PredictorService para gerar previsões.
"""
...
def main():
    """Função principal para testar a previsão usando o método de fallback"""
    print("="*80)
    print("TESTE DO ALGORITMO DE PREVISÃO PARA PARTIDAS DE LOL")
    ...
    # Desativar o modelo para forçar o uso do fallback
    ...
    print("\nTeste do algoritmo de previsão concluído com sucesso!")
    print("="*80)
